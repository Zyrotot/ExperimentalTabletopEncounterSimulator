...
int main() {
    ...
    auto damage_resolver = std::make_shared<internal::resolver::DamageResolver>(context);
    ...
    auto damage_resolver2 = std::make_shared<internal::resolver::DamageResolver>(context2);
